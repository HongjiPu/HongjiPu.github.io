...
<table width="100%">
  <tr>
    <td align="left"><strong>S&P 500 Futures and BTC Linked Strategy Based on Cross-Market Volatility Spillover Effect / Quantitative Researcher</strong></td>
...
<div style="text-align: justify;">
    ...
    <p style="text-indent: 0em; margin-bottom: 10px; margin-top: 0;">
         S&P 500 Volatility Surface Modeling & Factor Extraction: Processed 4 years of European option data to calibrate an Arbitrage-Free Implied Volatility Surface using the SSVI model and Differential Evolution (achieving WRMSE < 0.006). Extracted ATM Variance and Skew as key macro sentiment indicators to serve as inputs for downstream predictive models.
    </p>
